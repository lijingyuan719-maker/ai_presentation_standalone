...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      {
         h1: "即刻开启<br>AI 之旅",
         p: "AI 不是替代者，而是你的超级副驾驶。无论职场新人还是行业专家，掌握这些技能，都将让你成为不可替代的超级个体。"
      }
      ];
      ...
      // Set the interval for text rotation (e.g., every 8 seconds)
      setInterval(changeText, 8000); // 你可以在这里修改轮播时间，8000 代表 8 秒
   }
});
...
function animateCounter(element) {
   ...
   const suffix = element.getAttribute('data-suffix') || ''; // Add suffix logic
